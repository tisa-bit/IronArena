...
const handleCheckoutSessionCompleted = async (req) => {
  ...
  //   if (!userId) throw new Error("Webhook: UserId missing in metadata");
  //   if (!planId) throw new Error("Webhook: PlanId missing in metadata");
  ...
  //   });
  //   if (activeSub) {
  //     console.log("User already has an active subscription, ignoring webhook");
  //     return { status: 200 };
  //   }
